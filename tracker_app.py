...
pts_tw_l = combined[combined["Week Date"] == this_week]["Points (Lauren)"]
pts_lw_l = combined[combined["Week Date"] == last_week]["Points (Lauren)"]
...
pts_tw_t = combined[combined["Week Date"] == this_week]["Points (Tara)"]
pts_lw_t = combined[combined["Week Date"] == last_week]["Points (Tara)"]
